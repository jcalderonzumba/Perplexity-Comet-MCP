...
The Pro battery's known-failures list names the Agentic browsing plan for Comet answering without opening the site a prompt names (`[3.1]`, `[3.2-agent-tab]`, `[3.3-tabs-kept]`, `[3.4]`, `[6.3]`), and lists the switch to `learn` as the no-pro battery does.
